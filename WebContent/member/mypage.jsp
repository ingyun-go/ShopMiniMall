	...
	<div id="contentWrap">
		<div class="formBox">
			...
			<form action="MemberUpdateServlet" method="post">
				...
				<input type="text" value="<%=addr1%>" name="addr1" id="sample4_roadAddress" placeholder="도로명주소" size="80"><br>
				<input type="text" value="<%=addr2%>" name="addr2" id="sample4_jibunAddress" placeholder="지번주소" size="80">
				<span id="guide" style="color: #999"></span> <br>
				
				전화번호:
				<select name="phone1">
					<option value="<%=phone1%>" <% if("017".equals(phone1)) {%> selected <%}%>>017</option>
					<option value="<%=phone1%>" <% if("011".equals(phone1)) {%> selected <%}%>>011</option>
					<option value="<%=phone1%>" <% if("010".equals(phone1)) {%> selected <%}%>>010</option>
				</select> - 
